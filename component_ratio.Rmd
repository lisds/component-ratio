...
is the kind of thing you'd cover in the middle of maths A-level, but you do it
without having done maths A-level if you're committed — the background is
fairly light.
...
comes with a *loading* that expresses the extend to which the component
...
not vary together, there will not be strong patterns, the components will all
